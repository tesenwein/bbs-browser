...
from .constants import (
    ...
    MAX_LINKS, NOISE_ROLES, SKIP_SCHEMES, TEASER_MIN_CHARS, USER_AGENT,
...
def firecrawl_api_key(cfg):
    ...
    because sysop pulls page back in."""
...
def fetch_source(url, firecrawl_cfg=None):
    ...
    if (cfg.get("enabled") and not cfg.get("use_mcp") and (api_key or base)
        ...
        html, _md, raw, _err = firecrawl_scrape(url, api_key, base)
        source = raw or html
        if source:
            return source, url
    else:
